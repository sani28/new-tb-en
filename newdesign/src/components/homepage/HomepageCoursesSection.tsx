...
const tour01AddonTitleClass = "card-title text-left text-[#000] font-medium";
...
function AddonCard({
  ...
  titleClass = "card-title text-[#000] font-medium text-[15px] tracking-tight leading-tight m-0 pt-3 px-[15px]",
