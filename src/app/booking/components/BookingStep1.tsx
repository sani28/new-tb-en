  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3 border-b border-[#eee] px-6 py-5">
        ...
        <span className="text-lg font-semibold text-text-dark">Plan Your Visit</span>
      </div>
      <div className="p-6 max-md:p-4">
        ...
        <div className="mb-5 flex gap-3">
          ...
          <div className="flex-1 rounded-xl border border-[#eee] bg-[#f8f9fa] px-4 py-3" data-type="adult">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-semibold text-text-dark">Adult</div>
                <div className="text-xs text-text-gray">Ages 19-64</div>
              </div>
          ...
          <div className="flex-1 rounded-xl border border-[#eee] bg-[#f8f9fa] px-4 py-3" data-type="child">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-semibold text-text-dark">Child</div>
                <div className="text-xs text-text-gray">Ages 3-18</div>
              </div>
              <div className="flex items-center gap-2 rounded-lg border border-[#eee] bg-white px-2 py-1.5">
        ...
        <button className="mt-5 w-full rounded-lg bg-brand-red p-4 text-base font-semibold text-white transition-colors hover:bg-brand-dark-red" onClick={onContinue}>Find Available Tours</button>
      </div>
    </>
  );
}
