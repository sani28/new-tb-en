    ...
    <>
      ...
      <div className="flex items-center justify-between border-b border-[#eee] px-6 py-5">
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-semibold text-text-dark">Available Tours</span>
        </div>
